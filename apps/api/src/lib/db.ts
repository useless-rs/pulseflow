...
export function seed() {
  ...
  const demoId = 'u_demo';
  db.users.push({ id: demoId, name: 'Demo User', email: 'demo@pulseflow.io', passwordHash: '$2a$10$7Eq9K2k3Q9vZ9vZ9vZ9vZuQ9vZ9vZ9vZ9vZ9vZ9vZ9vZ9vZ9vZ9u', role: 'admin', createdAt: now() });
